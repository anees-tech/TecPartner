      ...
      <div className="container p-6 mx-auto">
        <div className="lg:flex">
          <div className="w-full -mx-6 lg:w-2/5">
            <div className="px-6">
              <a href="#">
                <h3 className="w-auto h-7 font-bold text-[16px]">
                  ABOUT TECPARTNER
                </h3>
              </a>

              <p className="max-w-sm mt-2 text-gray-500 dark:text-gray-400">
                <span className="text-gray-500 font-semibold">TecPartner</span>{" "}
                is a recruiting and consulting firm passionate about connecting
                talented individuals with their dream careers.{" "}
                <span className="text-gray-500 font-semibold">TecPartner</span>{" "}
                understands that people are at the heart of every successful
                organization, and we strive to create meaningful connections
                between employers and job seekers by providing exceptional
                recruiting and consultation services.
              </p>
            </div>
          </div>
